...
import { removedFromCart } from '../../services/slices/cart-slice';
...
export const CartItem = (props : TProps) => {
    const dispatch = useAppDispatch();

     // хэндлер удаления товара из корзины
    const deleteFromCart = useCallback((props : TProps) => {
        dispatch(removedFromCart({id: props.item.id, price: props.item.price, quantity: props.quantity}))
    }, [dispatch]);
    ...
    return (
        <div className={styles.general}>
            ...
            {/* иконка удаления товара из корзины и общая цена за n кол-во этого товара */}
            <div className={styles.deleteAndPrice}>
            <svg onClick={() => deleteFromCart(props)} width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.delete}>
