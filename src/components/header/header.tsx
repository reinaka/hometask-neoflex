...
import { selectAllItems, selectTotalQuantity } from '../../services/selector-functions';
            ...
            <header className={styles.general}>
                <div className={styles.wrapper}>
                    ...
                    <nav className={styles.headerNavigation}>
                        <HeaderIcon count={favoriteItems.length} to="/favourites">
                        ...
                        <HeaderIcon count={totalQuantity} to="/shoppingCart">
