import mockImage from '../../images/S852I.png';
    ...
    return (
        <div className={styles.general}>
            <div className={styles.photoAndQuantity}>
                <img src={mockImage} alt='ghj' className={styles.image}/>
                <QuantityControls/>
            </div>
            <div className={styles.titleAndPrice}>
                <div className={styles.title}>Apple BYZ S852I</div>
                <div className={styles.price}>2 927 &#8381;</div>
            </div>
            <div className={styles.deleteAndPrice}>
            <svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.delete}>
